...
function CheckFirstLogin(props) {
    ...
    const OnCheckValidFirstLogin = () => {
        GetUserDetail(datUser.username).then((res) => {
            console.log('res', res);
            if (res && res.data) {
                ...
                <div className='container wrapper-page-check-first-login'>
                    ...
                    {isSuccess ? (
                        <p className='txt-2 mb-50px'>
                            Akun Anda telah berhasil merubah Kata Sandi. Gunakan
                            Kata Sandi baru Anda untuk mengakses kembali e-Arsip
                            setelah Logout. Apabila dibutuhkan, Anda bisa
                            merubah Kata Sandi di Menu Akun.
                        </p>
                    ) : (
                        <p className='txt-2 mb-50px'>
                            Akun Anda masih belum diperbolehkan mengakses
                            Dashboard secara menyeluruh, segera ubah Kata Sandi
                            untuk dapat mengakses e-Arsip. Kata Sandi tersebut
                            nantinya adalah Kata Sandi yang akan Anda gunakan
                            untuk Login ke e-Arsip.
                        </p>
                    )}
